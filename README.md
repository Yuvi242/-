...
# [कंटेनर](https://www.docker.com/resources/what-container/) क्या हैं?
![image alt](https://github.com/Yuvi242/Introduction-to-Containers-and-Images/blob/main/dockerfile-2.png?raw=true)
...
# [कंटेनर रनटाइम](https://www.wiz.io/academy/container-runtimes) क्या है?
![image alt](https://github.com/Yuvi242/Introduction-to-Containers-and-Images/blob/89aac5ab94fe907d15b0d7cfa79d337bfca5f417/container%20runtime.png)
...
# [कंटेनर रजिस्ट्री](https://www.wiz.io/academy/container-registries) क्या है?
...
# एक [कंटेनर इमेज](https://www.geeksforgeeks.org/what-is-docker-image/#what-is-docker-image) क्या है?
...
1. ### **प्रोग्राम लिखें:** मान लीजिए कि हमने संख्या का अनुमान लगाएं गेम पायथन में प्रोग्राम किया है, और इसे game.py नाम की एक फाइल में लिखा है।
...
2. ### **एक डॉकरफाईल बनाएँ:** इसके बाद, हमलोग game.py फाइल जिस फ़ोल्डर में है उसी फोल्डर में डॉकरफाईल नाम का एक फ़ाइल बनाएंगे। डॉकरफाईल, डॉकर को बताता है कि हमारे कंटेनर इमेज कैसे बनाई जाए।
...
3. ### **कंटेनर इमेज बनाएं:** एक बार जब हमारे पास डॉकरफ़ाइल हो, तो हम कंटेनर इमेज बनाने के लिए डॉकर का उपयोग करते हैं। हम लिनक्स सिस्टम पर अपना टर्मिनल खोलेंगे और निचे दिए हुए कमांड चलाएंगे:
   ...
   ```bash  
   sudo docker build -t guess-number-game .
   ```
...
1. ### **कंटेनर चलाएँ:** इमेज बनाने के बाद, कंटेनर रन करें:
   ...
   ```bash  
   sudo docker run -it guess-number-game
   ```
...
1. **प्रोग्राम लिखें:** हम पायथन का उपयोग करके एक गेम का प्रोग्राम लिखते हैं जहां खिलाड़ी एक संख्या का अनुमान लगाता है।  
     
2. **एक डॉकरफाईल बनाएं:** हम एक फ़ाइल बनाते हैं जो डॉकर को बताती है कि हमारे गेम को एक कंटेनर इमेज में कैसे पैक किया जाए।  
